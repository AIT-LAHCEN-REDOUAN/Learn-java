...
public class Project extends JFrame implements ActionListener {
    Project(){
           setSize(1920,1080);
        ImageIcon i1 = new ImageIcon(getClass().getResource("/University_system/icons/third.jpg"));
        ...
        JMenuItem facultyDetails = new JMenuItem("View Faculty Detail");
        facultyDetails.setBackground(Color.WHITE);
        details.add(facultyDetails);

        JMenuItem studentDetails = new JMenuItem("View Student Detail");
        ...
        updateinfo.setForeground(Color.PINK);
        mb.add(updateinfo);
